  ...
  return (
    <div className="sc-prod-card vt-card sc-fade-target group border border-white/5 bg-[#050505] relative">
      <div className="sc-prod-img-wrap overflow-hidden bg-[#0a0a0a] relative">
        ...
        <button className="sc-prod-add-btn sc-glass bg-white/10 hover:bg-white/20 text-white font-extrabold py-5 tracking-widest text-[10px] md:py-4 border-none backdrop-blur-xl">
          ADD TO BAG
        </button>
