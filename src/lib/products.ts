...
export const products: Product[] = [
  ...
  // m11 — referenced by mb3 bundle "Omni-Layer System"
  {
    id: "m11",
    name: 'Thermal Grid Sweatshirt',
    category: "men",
    price: 145,
    description: "Mid-layer heavyweight grid-fleece with ribbed cuffs.",
    details: ["400 GSM grid-fleece", "Ribbed cuffs & hem", "Drop-shoulder construction"],
    image: "https://images.unsplash.com/photo-1503341504253-dff4815485f1?auto=format&fit=crop&q=80&w=800",
    stockStatus: "in-stock",
  },

  // ─── MEN'S ACCESSORIES (placed in men's section) ───
  {
    id: "a7",
  ...
  // ─── MEN'S BUNDLES ───
  {
    ...
    price: 450,
    originalPrice: 485,
    description: "Full industrial deployment: Hoodie + Architectural Cargo + Ghost Tee.",
  ...
  },
  {
    ...
    price: 610,
    originalPrice: 715,
    description: "Modular layering for all conditions: Void Hoodie + Thermal Sweatshirt + Cargo.",
    details: ["Void Heavyweight Hoodie", "Thermal Grid Sweatshirt", "Architectural Cargo Pants"],
